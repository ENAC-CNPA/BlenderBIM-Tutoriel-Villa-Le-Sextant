const pages = [
    ...
    {
        id : "2",
        title: "Modéliser sur Blender",
        link: "modelisation-blender"
    },
    {
        id : "3",
    ...
    },
    {
        ...
        link: "types-et-familles"
    },
    {
        id : "7",
        title: "Symboles 2D et Annotations",
        link: "symboles-2d-et-annotations"
    },
    {
        id : "8",
        title: "Dessins et Mise en Page",
        link: "dessins-et-mise-en-page"
    },
    {
        id : "9",
        title: "Utiliser la Donnée - Exemple avec la 4D",
        link: "utilisation-de-la-donnee"
    },
    {
        id : "10",
...
const currentPageId = currentUrl.substring(currentUrl.lastIndexOf('/') + 1, currentUrl.lastIndexOf('_'));
...
const headerLogoEpflImg = document.createElement('img');
    ...
    headerLogoEpflImg.src = 'https://www.epfl.ch/wp/5.5/wp-content/themes/wp-theme-2018/assets/svg/epfl-logo.svg?refresh=now';
...
const headerLogoEnacImg = document.createElement('img');
    ...
    headerLogoEnacImg.alt = 'Logo ENAC, Faculté de l’environnement naturel, architectural et construit';
...
const headerLogoCnpaImg = document.createElement('img');
    ...
    headerLogoCnpaImg.alt = 'Logo CNPA, Laboratoire des cultures numériques du projet architectural';
